...
static void bench_ssbconv_options_initialize(void){
...
int bench_vecvec_fill_show_help(void){
  bench_ssbconv_options_initialize();
...
const char* bench_vecvec_fill_name(int argc, char** argv){
  ...
  snprintf(name_buffer, MAX_LINE * sizeof(char), "Benchmark [ssbconv] (fold = %d)", fold._int.value);
  return name_buffer;
}
