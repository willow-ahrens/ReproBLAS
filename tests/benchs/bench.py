...
attribute = "%peak"
bench_harness.add_suite(benchs.BenchSuite([benchs.BenchRDGEMVTest(), benchs.BenchDGEMVTest()], [("N", "M"), "O", "T"], [[(512, 512), (1024, 1024), (2048, 2048), (4096, 4096)], ["RowMajor"], ["NoTrans"]], "%peak"))
bench_harness.add_suite(benchs.BenchSuite([benchs.BenchRDGEMVTest(), benchs.BenchDGEMVTest()], [("N", "M"), "O", "T"], [[(512, 512), (1024, 1024), (2048, 2048), (4096, 4096)], ["RowMajor"], ["NoTrans"]], "freq"))
