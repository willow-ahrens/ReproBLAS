TARGETS := validate_internal_damax$(EXE) validate_internal_zamax$(EXE) validate_internal_samax$(EXE) validate_internal_camax$(EXE) \
           ...
           verify_dbdssq$(EXE) verify_dbzssq$(EXE) verify_sbsssq$(EXE) verify_sbcssq$(EXE) \
...
validate_internal_camax$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_camax.o
validate_internal_damax$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_damax.o
validate_internal_samax$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_samax.o
validate_internal_zamax$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_zamax.o
validate_internal_ufp$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_ufp.o
validate_internal_ufpf$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNEDBLAS) validate_internal_ufpf.o
validate_internal_dscale$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_dscale.o
validate_internal_sscale$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_sscale.o
validate_internal_dindex$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_dindex.o
validate_internal_sindex$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_sindex.o
validate_internal_dmindex$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_dmindex.o
validate_internal_smindex$(EXE)_DEPS = $$(LIBTEST) $$(LIBBINNED) validate_internal_smindex.o
...
verify_dbdssq$(EXE)_DEPS = $$(LIBTEST) $$(LIBREPROBLAS) verify_dbdssq.o
verify_dbzssq$(EXE)_DEPS = $$(LIBTEST) $$(LIBREPROBLAS) verify_dbzssq.o
verify_sbsssq$(EXE)_DEPS = $$(LIBTEST) $$(LIBREPROBLAS) verify_sbsssq.o
verify_sbcssq$(EXE)_DEPS = $$(LIBTEST) $$(LIBREPROBLAS) verify_sbcssq.o
...
validate_xblas_ddot$(EXE)_LIBS = -lm
validate_xblas_zdot$(EXE)_LIBS = -lm
validate_xblas_sdot$(EXE)_LIBS = -lm
validate_xblas_cdot$(EXE)_LIBS = -lm
verify_dbdssq$(EXE)_LIBS = -lm
verify_dbzssq$(EXE)_LIBS = -lm
verify_sbsssq$(EXE)_LIBS = -lm
verify_sbcssq$(EXE)_LIBS = -lm
