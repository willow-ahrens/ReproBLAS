      ...
      default:{
        ...
        if(incv == 1 && incy == 1){
          ...
          for(i = 0; i + 8 <= n; i += 8, v_base += 16, y_base += 16){
            ...
            v_8 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_0, v_0, 0b01), _mm_shuffle_pd(y_0, y_0, 0b11)), mask_NCONJ);
            v_9 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_1, v_1, 0b01), _mm_shuffle_pd(y_1, y_1, 0b11)), mask_NCONJ);
            v_10 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_2, v_2, 0b01), _mm_shuffle_pd(y_2, y_2, 0b11)), mask_NCONJ);
            v_11 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_3, v_3, 0b01), _mm_shuffle_pd(y_3, y_3, 0b11)), mask_NCONJ);
            v_12 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_4, v_4, 0b01), _mm_shuffle_pd(y_4, y_4, 0b11)), mask_NCONJ);
            v_13 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_5, v_5, 0b01), _mm_shuffle_pd(y_5, y_5, 0b11)), mask_NCONJ);
            v_14 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_6, v_6, 0b01), _mm_shuffle_pd(y_6, y_6, 0b11)), mask_NCONJ);
            v_15 = _mm_xor_pd(_mm_mul_pd(_mm_shuffle_pd(v_7, v_7, 0b01), _mm_shuffle_pd(y_7, y_7, 0b11)), mask_NCONJ);
            v_0 = _mm_mul_pd(v_0, _mm_shuffle_pd(y_0, y_0, 0b00));
            v_1 = _mm_mul_pd(v_1, _mm_shuffle_pd(y_1, y_1, 0b00));
