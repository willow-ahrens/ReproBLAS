...
void zIAdd_MPI(
	...
	for (i = 0; i < *len; i++) {
		...
		zmzmadd(fold, (double*)pin, 1, (double*)(pin + fold), 1, (double*)pout,1,  (double*)(pout + fold),1);
...
void dINrm2_MPI(
	...
	for (i = 0; i < *len; i++) {
		...
		dmdmadd(fold, (double*)pin + 1, 1, (double*)pin + fold + 1, 1, (double*)pout + 1, 1, (double*)pout + fold + 1, 1);
