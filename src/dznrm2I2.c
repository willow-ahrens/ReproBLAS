      ...
      case 3:{
        ...
        if(incv == 1){
          ...
          for(i = 0; i + 16 <= n; i += 16, v_base += 32){
            ...
            v_4 = _mm256_mul_pd(_mm256_loadu_pd(v_base + 16), scale_mask);
            v_5 = _mm256_mul_pd(_mm256_loadu_pd(v_base + 20), scale_mask);
            v_6 = _mm256_mul_pd(_mm256_loadu_pd(v_base + 24), scale_mask);
            v_7 = _mm256_mul_pd(_mm256_loadu_pd(v_base + 28), scale_mask);
          ...
          for(i = 0; i + 16 <= n; i += 16, v_base += (incv * 32)){
            ...
            v_4 = _mm256_mul_pd(_mm256_set_pd(v_base[((incv * 18) + 1)], v_base[(incv * 18)], v_base[((incv * 16) + 1)], v_base[(incv * 16)]), scale_mask);
            v_5 = _mm256_mul_pd(_mm256_set_pd(v_base[((incv * 22) + 1)], v_base[(incv * 22)], v_base[((incv * 20) + 1)], v_base[(incv * 20)]), scale_mask);
            v_6 = _mm256_mul_pd(_mm256_set_pd(v_base[((incv * 26) + 1)], v_base[(incv * 26)], v_base[((incv * 24) + 1)], v_base[(incv * 24)]), scale_mask);
            v_7 = _mm256_mul_pd(_mm256_set_pd(v_base[((incv * 30) + 1)], v_base[(incv * 30)], v_base[((incv * 28) + 1)], v_base[(incv * 28)]), scale_mask);
            v_0 = _mm256_mul_pd(v_0, v_0);
            v_1 = _mm256_mul_pd(v_1, v_1);
            v_2 = _mm256_mul_pd(v_2, v_2);
            v_3 = _mm256_mul_pd(v_3, v_3);
