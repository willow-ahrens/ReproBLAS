...
//[[[end]]]
  ...
  void snrm2I2(int n, float* v, int incv, float scale, int fold, float* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Float, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void snrm2I2(int n, float* v, int incv, float scale, int fold, float* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Float, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void snrm2I2(int n, float* v, int incv, float scale, int fold, float* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Float, vectorizations.SISD), args, params))
    ]]]*/
