 ...
 */
#if defined( SCASUMI2 )
void scasumI2(int n, scomplex* v, int incv, int fold, scomplex* sum) {
#endif
#if defined( SCNRM2I2 )
void scnrm2I2(int n, scomplex* v, int incv, float scale,
	int fold, scomplex* sum) {
#endif
#if defined( CSUMI2 )
void csumI2(int n, scomplex* v, int incv, int fold, scomplex* sum) {
#endif

	SET_DAZ_FLAG

	scomplex zBUF[2 * MAX_FOLD];
	int i, j;
