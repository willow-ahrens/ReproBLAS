...
//[[[end]]]
  ...
  void scasumI2(int n, float complex* v, int incv, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(asumI2.ASumI2(dataTypes.FloatComplex, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void scasumI2(int n, float complex* v, int incv, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(asumI2.ASumI2(dataTypes.FloatComplex, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void scasumI2(int n, float complex* v, int incv, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(asumI2.ASumI2(dataTypes.FloatComplex, vectorizations.SISD), args, params))
    ]]]*/
    int_float tmp_BLP;
    SET_DAZ_FLAG;
    switch(fold){
