...
//[[[end]]]
  ...
  void zdotcI2(int n, double complex* v, int incv, double complex* y, int incy, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.DoubleComplex, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void zdotcI2(int n, double complex* v, int incv, double complex* y, int incy, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.DoubleComplex, vectorizations.SSE), args, params))
    ]]]*/
    ...
    switch(fold){
      ...
      default:{
        ...
        for(j = 0; j < fold; j += 1){
          ...
          _mm_store_pd((double*)tmp_cons, s_buffer[(j * 4)]);
          sum[j] = tmp_cons[0];
        }
        RESET_DAZ_FLAG
        return;
  ...
  void zdotcI2(int n, double complex* v, int incv, double complex* y, int incy, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.DoubleComplex, vectorizations.SISD), args, params))
    ]]]*/
    long_double tmp_BLP;
    SET_DAZ_FLAG;
    switch(fold){
