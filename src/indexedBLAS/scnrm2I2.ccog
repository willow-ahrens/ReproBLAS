...
//[[[end]]]
  ...
  void scnrm2I2(int n, float complex* v, int incv, float scale, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.FloatComplex, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void scnrm2I2(int n, float complex* v, int incv, float scale, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.FloatComplex, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void scnrm2I2(int n, float complex* v, int incv, float scale, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.FloatComplex, vectorizations.SISD), args, params))
    ]]]*/
