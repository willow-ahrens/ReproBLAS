...
//[[[end]]]
  ...
  void cdotcI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.FloatComplex, vectorizations.AVX), args, params))
    ]]]*/
      ...
      case 3:{
        ...
        if(incv == 1){
          if(incy == 1){
            ...
            for(i = 0; i + 16 <= n; i += 16, v_base += 32, y_base += (incy * 32)){
              v_0 = _mm256_loadu_ps(v_base);
              v_1 = _mm256_loadu_ps(v_base + 8);
              v_2 = _mm256_loadu_ps(v_base + 16);
              v_3 = _mm256_loadu_ps(v_base + 24);
          ...
          if(incy == 1){
            ...
            for(i = 0; i + 16 <= n; i += 16, v_base += (incv * 32), y_base += 32){
          ...
          if(incy == 1){
            ...
            for(i = 0; i + 16 <= n; i += 16, v_base += 32, y_base += 32){
              ...
              for(j = 0; j < fold - 1; j++){
                ...
                s_2 = s_buffer[((j * 4) + 2)];
                s_3 = s_buffer[((j * 4) + 3)];
                q_0 = _mm256_add_ps(s_0, _mm256_or_ps(v_4, mask_BLP));
                q_1 = _mm256_add_ps(s_1, _mm256_or_ps(v_5, mask_BLP));
                q_2 = _mm256_add_ps(s_2, _mm256_or_ps(v_6, mask_BLP));
                q_3 = _mm256_add_ps(s_3, _mm256_or_ps(v_7, mask_BLP));
                s_buffer[(j * 4)] = q_0;
                s_buffer[((j * 4) + 1)] = q_1;
                s_buffer[((j * 4) + 2)] = q_2;
                s_buffer[((j * 4) + 3)] = q_3;
              ...
              s_buffer[(j * 4)] = _mm256_add_ps(s_buffer[(j * 4)], _mm256_or_ps(v_4, mask_BLP));
              s_buffer[((j * 4) + 1)] = _mm256_add_ps(s_buffer[((j * 4) + 1)], _mm256_or_ps(v_5, mask_BLP));
              s_buffer[((j * 4) + 2)] = _mm256_add_ps(s_buffer[((j * 4) + 2)], _mm256_or_ps(v_6, mask_BLP));
              s_buffer[((j * 4) + 3)] = _mm256_add_ps(s_buffer[((j * 4) + 3)], _mm256_or_ps(v_7, mask_BLP));
            }
            if(i + 8 <= n){
              v_0 = _mm256_loadu_ps(v_base);
              v_1 = _mm256_loadu_ps(v_base + 8);
  ...
  void cdotcI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.FloatComplex, vectorizations.SSE), args, params))
    ]]]*/
          ...
          if(incy == 1){
            ...
            for(i = 0; i + 8 <= n; i += 8, v_base += 16, y_base += 16){
              ...
              for(j = 0; j < fold - 1; j++){
                ...
                s_2 = s_buffer[((j * 4) + 2)];
                s_3 = s_buffer[((j * 4) + 3)];
                q_0 = _mm_add_ps(s_0, _mm_or_ps(v_4, mask_BLP));
                q_1 = _mm_add_ps(s_1, _mm_or_ps(v_5, mask_BLP));
                q_2 = _mm_add_ps(s_2, _mm_or_ps(v_6, mask_BLP));
                q_3 = _mm_add_ps(s_3, _mm_or_ps(v_7, mask_BLP));
                s_buffer[(j * 4)] = q_0;
                s_buffer[((j * 4) + 1)] = q_1;
                s_buffer[((j * 4) + 2)] = q_2;
                s_buffer[((j * 4) + 3)] = q_3;
              ...
              s_buffer[(j * 4)] = _mm_add_ps(s_buffer[(j * 4)], _mm_or_ps(v_4, mask_BLP));
              s_buffer[((j * 4) + 1)] = _mm_add_ps(s_buffer[((j * 4) + 1)], _mm_or_ps(v_5, mask_BLP));
              s_buffer[((j * 4) + 2)] = _mm_add_ps(s_buffer[((j * 4) + 2)], _mm_or_ps(v_6, mask_BLP));
              s_buffer[((j * 4) + 3)] = _mm_add_ps(s_buffer[((j * 4) + 3)], _mm_or_ps(v_7, mask_BLP));
            }
            if(i + 4 <= n){
              v_0 = _mm_loadu_ps(v_base);
              v_1 = _mm_loadu_ps(v_base + 4);
  ...
  void cdotcI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotcI2.DotCI2(dataTypes.FloatComplex, vectorizations.SISD), args, params))
    ]]]*/
    int_float tmp_BLP;
    SET_DAZ_FLAG;
    switch(fold){
      case 3:{
        ...
        float* v_base = (float*) v;
        float* y_base = (float*) y;
        float v_0, v_1, v_2, v_3, v_4, v_5, v_6, v_7, v_8, v_9, v_10, v_11, v_12, v_13, v_14, v_15;
