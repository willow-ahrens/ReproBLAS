...
//[[[end]]]
  ...
  void dnrm2I2(int n, double* v, int incv, double scale, int fold, double* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Double, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void dnrm2I2(int n, double* v, int incv, double scale, int fold, double* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Double, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void dnrm2I2(int n, double* v, int incv, double scale, int fold, double* sum){
    /*[[[cog
    cog.out(generate.generate(nrm2I2.Nrm2I2(dataTypes.Double, vectorizations.SISD), args, params))
    ]]]*/
      ...
      case 3:{
        ...
        if(incv == 1){
          ...
          for(i = 0; i + 4 <= n; i += 4, v += (incv * 4)){
            ...
            v_2 = v[(incv * 2)] * scale_mask;
            v_3 = v[(incv * 3)] * scale_mask;
            v_0 = v_0 * v_0;
            v_1 = v_1 * v_1;
            v_2 = v_2 * v_2;
            v_3 = v_3 * v_3;
