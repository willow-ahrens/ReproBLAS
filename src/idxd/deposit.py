...
#    self.set_daz_ftz(code_block)
  ...
  def write_core(self, code_block, fold, max_pipe_width, max_unroll_width, incs):
    ...
    if self.data_type.is_complex:
      ...
      code_block.indent()
      code_block.set_equal(self.compression_vars, itertools.cycle(self.vec.set("idxd_{0}MCOMPRESSION".format(self.data_type.base_type.name_char.upper()))))
      code_block.set_equal(self.expansion_vars, itertools.cycle(self.vec.set("idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()))))
      code_block.set_equal(self.expansion_mask_vars, itertools.cycle(self.vec.set("idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()))))
      code_block.dedent()
      code_block.write("}else{")
      code_block.indent()
      code_block.set_equal(self.compression_vars, itertools.cycle(self.vec.set_real_imag("idxd_{0}MCOMPRESSION".format(self.data_type.base_type.name_char.upper()), "1.0")))
      code_block.set_equal(self.expansion_vars, itertools.cycle(self.vec.set_real_imag("idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()), "1.0")))
      code_block.set_equal(self.expansion_mask_vars, itertools.cycle(self.vec.set_real_imag("idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()), "0.0")))
      code_block.dedent()
      code_block.write("}")
      code_block.dedent()
      code_block.write("}else{")
      code_block.indent()
      code_block.set_equal(self.compression_vars, itertools.cycle(self.vec.set_real_imag("1.0", "idxd_{0}MCOMPRESSION".format(self.data_type.base_type.name_char.upper()))))
      code_block.set_equal(self.expansion_vars, itertools.cycle(self.vec.set_real_imag("1.0", "idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()))))
      code_block.set_equal(self.expansion_mask_vars, itertools.cycle(self.vec.set_real_imag("0.0", "idxd_{0}MEXPANSION * 0.5".format(self.data_type.base_type.name_char.upper()))))
      code_block.dedent()
      code_block.write("}")
