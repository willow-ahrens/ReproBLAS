    ...
    switch(fold){
      case 3:{
        ...
        if(incv == 1 && incy == 1){
          ...
          for(i = 0; i + 16 <= n; i += 16, v_base += 32, y_base += 32){
            ...
            v_4 = _mm256_xor_ps(_mm256_mul_ps(_mm256_permute_ps(v_0, 0b10110001), _mm256_permute_ps(y_0, 0b11110101)), mask_CONJ);
            v_5 = _mm256_xor_ps(_mm256_mul_ps(_mm256_permute_ps(v_1, 0b10110001), _mm256_permute_ps(y_1, 0b11110101)), mask_CONJ);
            v_6 = _mm256_xor_ps(_mm256_mul_ps(_mm256_permute_ps(v_2, 0b10110001), _mm256_permute_ps(y_2, 0b11110101)), mask_CONJ);
            v_7 = _mm256_xor_ps(_mm256_mul_ps(_mm256_permute_ps(v_3, 0b10110001), _mm256_permute_ps(y_3, 0b11110101)), mask_CONJ);
      ...
      default:{
        ...
        for(j = 0; j < fold; j += 1){
          ...
          _mm256_store_ps((float*)tmp_cons, s_buffer[(j * 4)]);
      ...
      default:{
        ...
        if(incv == 1 && incy == 1){
          ...
          for(i = 0; i + 8 <= n; i += 8, v_base += 16, y_base += 16){
            ...
            v_4 = _mm_xor_ps(_mm_mul_ps(_mm_shuffle_ps(v_0, v_0, 0b10110001), _mm_shuffle_ps(y_0, y_0, 0b11110101)), mask_CONJ);
            v_5 = _mm_xor_ps(_mm_mul_ps(_mm_shuffle_ps(v_1, v_1, 0b10110001), _mm_shuffle_ps(y_1, y_1, 0b11110101)), mask_CONJ);
            v_6 = _mm_xor_ps(_mm_mul_ps(_mm_shuffle_ps(v_2, v_2, 0b10110001), _mm_shuffle_ps(y_2, y_2, 0b11110101)), mask_CONJ);
            v_7 = _mm_xor_ps(_mm_mul_ps(_mm_shuffle_ps(v_3, v_3, 0b10110001), _mm_shuffle_ps(y_3, y_3, 0b11110101)), mask_CONJ);
            v_0 = _mm_mul_ps(v_0, _mm_shuffle_ps(y_0, y_0, 0b10100000));
            v_1 = _mm_mul_ps(v_1, _mm_shuffle_ps(y_1, y_1, 0b10100000));
        ...
        for(j = 0; j < fold; j += 1){
          ...
          _mm_store_ps((float*)tmp_cons, s_buffer[(j * 8)]);
