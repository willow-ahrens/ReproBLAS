  ...
  void cdotcI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    ...
    switch(fold){
      case 3:{
        ...
        float s_0_0, s_0_1, s_0_2, s_0_3, s_0_4, s_0_5, s_0_6, s_0_7;
        float s_1_0, s_1_1, s_1_2, s_1_3, s_1_4, s_1_5, s_1_6, s_1_7;
        float s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7;
        ...
        if(incv == 1){
          if(incy == 1){
            ...
            for(i = 0; i + 2 <= n; i += 2, v_base += 4, y_base += 4){
              ...
              tmp_BLP.f = v_4;
              tmp_BLP.i |= 1;
              s_0_4 = s_0_4 + tmp_BLP.f;
              tmp_BLP.f = v_5;
              tmp_BLP.i |= 1;
              s_0_5 = s_0_5 + tmp_BLP.f;
              tmp_BLP.f = v_6;
              tmp_BLP.i |= 1;
              s_0_6 = s_0_6 + tmp_BLP.f;
              tmp_BLP.f = v_7;
              tmp_BLP.i |= 1;
              s_0_7 = s_0_7 + tmp_BLP.f;
              q_0 = q_0 - s_0_0;
              q_1 = q_1 - s_0_1;
              q_2 = q_2 - s_0_2;
              q_3 = q_3 - s_0_3;
              ...
              tmp_BLP.f = v_4;
              tmp_BLP.i |= 1;
              s_1_4 = s_1_4 + tmp_BLP.f;
              tmp_BLP.f = v_5;
              tmp_BLP.i |= 1;
              s_1_5 = s_1_5 + tmp_BLP.f;
              tmp_BLP.f = v_6;
              tmp_BLP.i |= 1;
              s_1_6 = s_1_6 + tmp_BLP.f;
              tmp_BLP.f = v_7;
              tmp_BLP.i |= 1;
              s_1_7 = s_1_7 + tmp_BLP.f;
              q_0 = q_0 - s_1_0;
              q_1 = q_1 - s_1_1;
              q_2 = q_2 - s_1_2;
              q_3 = q_3 - s_1_3;
              ...
              tmp_BLP.f = v_4;
              tmp_BLP.i |= 1;
              s_2_4 = s_2_4 + tmp_BLP.f;
              tmp_BLP.f = v_5;
              tmp_BLP.i |= 1;
              s_2_5 = s_2_5 + tmp_BLP.f;
              tmp_BLP.f = v_6;
              tmp_BLP.i |= 1;
              s_2_6 = s_2_6 + tmp_BLP.f;
              tmp_BLP.f = v_7;
              tmp_BLP.i |= 1;
              s_2_7 = s_2_7 + tmp_BLP.f;
            }
            if(i + 1 <= n){
              v_0 = v_base[0];
              v_1 = v_base[1];
