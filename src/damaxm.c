...
#include <emmintrin.h>
  ...
  double damaxm(int n, double* v, int incv, double* y, int incy){
    ...
    __m128d y_0, y_1, y_2, y_3, y_4, y_5, y_6, y_7, y_8, y_9, y_10, y_11, y_12, y_13, y_14, y_15;
    __m128d m_0;
    m_0 = _mm_setzero_pd();
    ...
    if(incv == 1 && incy == 1){
      ...
      for(i = 0; i + 32 <= n; i += 32, v += 32, y += 32){
        ...
        y_12 = _mm_loadu_pd(y + 24);
        y_13 = _mm_loadu_pd(y + 26);
        y_14 = _mm_loadu_pd(y + 28);
        y_15 = _mm_loadu_pd(y + 30);
        ...
        v_8 = _mm_and_pd(_mm_mul_pd(v_8, y_8), mask_ABS);
        v_9 = _mm_and_pd(_mm_mul_pd(v_9, y_9), mask_ABS);
        v_10 = _mm_and_pd(_mm_mul_pd(v_10, y_10), mask_ABS);
        v_11 = _mm_and_pd(_mm_mul_pd(v_11, y_11), mask_ABS);
        v_12 = _mm_and_pd(_mm_mul_pd(v_12, y_12), mask_ABS);
        v_13 = _mm_and_pd(_mm_mul_pd(v_13, y_13), mask_ABS);
        v_14 = _mm_and_pd(_mm_mul_pd(v_14, y_14), mask_ABS);
        v_15 = _mm_and_pd(_mm_mul_pd(v_15, y_15), mask_ABS);
      ...
      for(i = 0; i + 32 <= n; i += 32, v += (incv * 32), y += (incy * 32)){
        ...
        y_12 = _mm_set_pd(y[(incy * 25)], y[(incy * 24)]);
        y_13 = _mm_set_pd(y[(incy * 27)], y[(incy * 26)]);
        y_14 = _mm_set_pd(y[(incy * 29)], y[(incy * 28)]);
        y_15 = _mm_set_pd(y[(incy * 31)], y[(incy * 30)]);
        v_0 = _mm_and_pd(_mm_mul_pd(v_0, y_0), mask_ABS);
        v_1 = _mm_and_pd(_mm_mul_pd(v_1, y_1), mask_ABS);
        v_2 = _mm_and_pd(_mm_mul_pd(v_2, y_2), mask_ABS);
        v_3 = _mm_and_pd(_mm_mul_pd(v_3, y_3), mask_ABS);
  ...
  double damaxm(int n, double* v, int incv, double* y, int incy){
    ...
    double y_0, y_1, y_2, y_3, y_4, y_5, y_6, y_7, y_8, y_9, y_10, y_11, y_12, y_13, y_14, y_15, y_16, y_17, y_18, y_19, y_20, y_21, y_22, y_23, y_24, y_25, y_26, y_27, y_28, y_29, y_30, y_31;
    double m_0;
    m_0 = 0;
