...
//[[[end]]]
  ...
  void cdotuI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotuI2.DotUI2(dataTypes.FloatComplex, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void cdotuI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotuI2.DotUI2(dataTypes.FloatComplex, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void cdotuI2(int n, float complex* v, int incv, float complex* y, int incy, int fold, float complex* sum){
    /*[[[cog
    cog.out(generate.generate(dotuI2.DotUI2(dataTypes.FloatComplex, vectorizations.SISD), args, params))
    ]]]*/
    int_float tmp_BLP;
    SET_DAZ_FLAG;
    switch(fold){
