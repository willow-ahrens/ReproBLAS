...
//[[[end]]]
  ...
  void zsumI2(int n, double complex* v, int incv, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(sumI2.SumI2(dataTypes.DoubleComplex, vectorizations.AVX), args, params))
    ]]]*/
  ...
  void zsumI2(int n, double complex* v, int incv, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(sumI2.SumI2(dataTypes.DoubleComplex, vectorizations.SSE), args, params))
    ]]]*/
  ...
  void zsumI2(int n, double complex* v, int incv, int fold, double complex* sum){
    /*[[[cog
    cog.out(generate.generate(sumI2.SumI2(dataTypes.DoubleComplex, vectorizations.SISD), args, params))
    ]]]*/
    long_double tmp_BLP;
    SET_DAZ_FLAG;
    switch(fold){
