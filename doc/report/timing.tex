\subsection{Timing}
  ...
  \begin{figure}[H]
  \begin{center}
  \includegraphics[width=\textwidth]{plots/easy_vs_hard.svg}
  ...
  \begin{figure}[H]
  \begin{center}
  \includegraphics[width=\textwidth]{plots/sum_comparison.svg}
  ...
  \begin{figure}[H]
  \begin{center}
  \includegraphics[width=\textwidth]{plots/dot_comparison.svg}
  ...
  \begin{figure}[H]
  \begin{center}
  \includegraphics[width=\textwidth]{plots/gemv_comparison.svg}
  ...
  \begin{figure}[H]
  \begin{center}
  \includegraphics[width=\textwidth]{plots/gemm_comparison.svg}
