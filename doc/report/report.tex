...
\section{Basic Operations}
  ...
  \subsection{Limits}
    ...
    As discussed in section \ref{sec:underflow}, only input corresponding to the bin $(e_{\min} - 2, e_{\max} + 1]$ is guaranteed to be accumulated.
