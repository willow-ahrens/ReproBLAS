...
\begin{comment}
      Let $T_0 = \overline{T_0} = \overline{S_m}$, $T_k = T_{k - 1} + f_{k + m - 1}$, and $\overline{T_k} = \fl(\overline{T_{k - 1}} + f_{k + m - 1})$ so that $T_{n - 1 - m} = \overline{S_m} + \sum\limits_{k = m + 1}^{n - 1}f_k$ and $\overline{T_{n - 1 - m}} = \overline{S_{n - 1}}$.

      \begin{equation*}
        |S_{m + 4} - \overline{S_{m + 4}}| = |S_{m + 4} - \overline{T_{4}}| = |S_{m + 4} - S_m + S_m - \overline{S_m} + \overline{S_m} - \overline{T_4}|
      \end{equation*}
      \begin{equation*}
        = |\sum\limits_{k = m + 1}^{m + 4} f_k + S_m - \overline{S_m} + \overline{S_m} - \overline{T_4}| = |S_m - \overline{S_m} + \overline{S_m} + \sum\limits_{k = m + 1}^{m + 4} f_k - \overline{T_4}|
      \end{equation*}
      \begin{equation*}
        = |S_m - \overline{S_m} + T_4 - \overline{T_4}| \leq |S_m - \overline{S_m}| + |T_4 - \overline{T_4}|
      \end{equation*}
       and by Equations 1.2 and 2.4 from \cite{higham},
      \begin{equation*}
        |S_{m + 4} - \overline{S_{m + 4}}| \leq |S_m - \overline{S_m}|  + (\frac{4\epsilon}{1 - 4 \epsilon})|T_0 + f_{m + 1}| + (\frac{3\epsilon}{1 - 3 \epsilon})\sum\limits_{k = m + 2}^{m + 4}|f_k|
      \end{equation*}
      \begin{equation*}
        \leq |S_m - \overline{S_m}| + (\frac{4\epsilon}{1 - 4 \epsilon})|\overline{S_m} - S_m + S_m + f_{m + 1}| + (\frac{3\epsilon}{1 - 3 \epsilon})\sum\limits_{k = m + 2}^{m + 4}|f_k|
      \end{equation*}
      \begin{equation*}
        \leq (\frac{1}{1 - 4\epsilon})|S_m - \overline{S_m}| + (\frac{4\epsilon}{1 - 4 \epsilon})|S_m + f_{m + 1}| + (\frac{3\epsilon}{1 - 3 \epsilon})\sum\limits_{k = m + 2}^{m + 4}|f_k|
      \end{equation*}
      \begin{equation*}
        \leq (\frac{1}{1 - 4\epsilon})|S_m - \overline{S_m}| +(\frac{4\epsilon}{1 - 4 \epsilon})(|\sum\limits_{k = 0}^{n - 1}f_k| + |\sum\limits_{k = m + 2}^{n - 1}f_k|) + (\frac{3\epsilon}{1 - 4 \epsilon})\sum\limits_{k = m + 2}^{n - 1}|f_k|
      \end{equation*}
      \begin{equation*}
        \leq (\frac{1}{1 - 4\epsilon})|S_m - \overline{S_m}| +(\frac{4\epsilon}{1 - 4 \epsilon})|\sum\limits_{k = 0}^{n - 1}f_k| + (\frac{7\epsilon}{1 - 4 \epsilon})\sum\limits_{k = m + 2}^{n - 1}|f_k|
      \end{equation*}
      \begin{equation*}
        \leq (\frac{1}{1 - 4\epsilon})(\epsilon|S_m| + 4\epsilon|\sum\limits_{k = 0}^{n - 1}f_k| + 7\epsilon\sum\limits_{k = m + 2}^{n - 1}|f_k|)
      \end{equation*}
      and by \eqref{eq:smrelsbound} and \eqref{eq:smpprelsbound},
      \begin{equation*}
        |S_{m + 4} - \overline{S_{m + 4}}| \leq (\frac{1}{1 - 4\epsilon})(\frac{2\epsilon}{1 - 4\sqrt\epsilon}|\sum\limits_{k = 0}^{n - 1}f_k| + \frac{4\epsilon - 16\epsilon\sqrt\epsilon}{1 - 4\sqrt\epsilon}|\sum\limits_{k = 0}^{n - 1}f_k| + \frac{28\epsilon\sqrt\epsilon}{1 - 4\sqrt\epsilon}|\sum\limits_{k = 0}^{n - 1}f_k|)
      \end{equation*}
      \begin{equation}
        = \frac{6 + 12\sqrt\epsilon}{(1 - 4\epsilon)(1 - 4\sqrt\epsilon)}\epsilon|\sum\limits_{k = 0}^{n - 1}f_k| = \frac{6}{(1 - 2\sqrt\epsilon)(1 - 4\sqrt\epsilon)}\epsilon|\sum\limits_{k = 0}^{n - 1}f_k|
        \label{eq:smfiveerror}
      \end{equation}
\end{comment}
