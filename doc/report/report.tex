...
\section{The Indexed Type}
  \label{sec:indexed}
    ...
    \subsubsection{Gradual Underflow}
      ...
      This means that we can approximate $x$ using the sum of its slices to the nearest multiple of $2^{e_{\min}}$.
